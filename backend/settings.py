...
class _UiSettings(BaseSettings):
    ...
    title: str = "APEC Johnny5.tech Chatbot"
    logo: Optional[str] = None
    chat_logo: Optional[str] = None
    chat_title: str = "Start chatting"
    chat_description: str = "This chatbot was developed by APEC to provide an exceptional experience in addressing your questions about Petroleum Systems"
